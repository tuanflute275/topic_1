...
$peoples = mysqli_fetch_array($result);
...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE `people` SET `name`='$name',`province_id`='$province',`avatar`='$file_name',`birthday`='$birthday',`gender`='$gender',`about`='$description' WHERE id = '$id'";
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" id="" class="form-control" value="<?= $peoples['name'] ?>" placeholder="Nhập tên người dân">
                                ...
                                <div class="form-group">
                                    <select class="form-control" name="province" id="">
                                        ...
                                        foreach ($provinces as $value) : ?>
                                            <option value="<?= $value['id'] ?>" <?= ($value['id'] == $peoples['province_id']) ? "selected" : "" ?>>
                                                <?= $value['id'] ?> - <?= $value['name'] ?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="birthday" id="" class="form-control" value="<?= $peoples['birthday'] ?>" placeholder="dd//mm//yyyy">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="file" name="avatar" id="" class="form-control" value="<?= $peoples['avatar'] ?>" placeholder="">
                                <div style="width: 20%;">
                                    <img src="./uploads/<?= $peoples['avatar'] ?>" alt="<?= $peoples['avatar'] ?>" class="card-img">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="description" placeholder="<?= $peoples['about'] ?>" id="" rows="3"></textarea>
                            </div>
                        </div>
                    </div>
